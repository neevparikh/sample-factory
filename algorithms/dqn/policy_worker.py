...
from algorithms.base.policy_worker import PolicyWorkerBase
from algorithms.dqn.model import create_dqn
from utils.timing import Timing
from utils.utils import AttrDict, log, join_or_kill, dict_of_lists_append 


class PolicyWorker(PolicyWorkerBase):
    def __init__(
    ...
    def _run(self):
        ...
        with timing.timeit('init'):
            ...
            self.dqn = create_dqn(self.cfg, self.obs_space, self.action_space, timing)
            self.dqn.model_to_device(self.device)
